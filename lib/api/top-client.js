 ...
 */
TopClient.prototype.invoke = function (type, method, params, reponseNames) {
  let res
  let rej
...
TopClient.prototype.execute = function (apiname, params) {
  return this.invoke('post',apiname, params, [util.getApiResponseName(apiname)])
}

TopClient.prototype.get = function (apiname, params) {
  return this.invoke('get',apiname, params, [util.getApiResponseName(apiname)])
}
